       ...
       01 DIGITO                 PIC 9.
       01 DIGITO-OK              PIC X VALUE SPACES.
      ...
      * Registro no encontrado, es un nuevo producto
           DISPLAY "Ingrese DIGITO CONTROL del producto: "
           ACCEPT NUEVO-PRODUCTO-CONTROL
      ...
      * Solo si el dígito es válido, proceder a guardar
                IF DIGITO-OK = "OK"
                    MOVE NUEVO-PRODUCTO-ID TO PRODUCTO-ID
                    ...
                    MOVE NUEVO-PRODUCTO-CONTROL TO PRODUCTO-CONTROL
                   ...
                   DISPLAY "Producto no guardado. Codigo de estado: "
                    ...
                    END-IF
                ELSE
                    DISPLAY "Dígito de control incorrecto."
                END-IF
            NOT INVALID KEY
      * Registro duplicado
      ...
      * Cerrar el archivo después de finalizar
       ...
       CALCULO-DIGITO.
           CALL "DigitoC" USING NUEVO-PRODUCTO-ID, DIGITO END-CALL.
           IF DIGITO NOT EQUAL NUEVO-PRODUCTO-CONTROL
           DISPLAY " ------PRODUCTO MAL INGRESADO ---" NUEVO-PRODUCTO-ID
           DISPLAY "DIGITO MAL INGRESADO"
           DISPLAY "Intente ingresar el dígito de control nuevamente."
           ELSE
